  ...
  return (
    ...
    <header className='header-top-strip py-3'>
      <div className='container'>
        <div className='row'>
          <div className='col-6'>
            <p className='text-white nb-0'>Free Shipping Over $100 & Free Returns</p>
           </div>
           <div className='col-6'>
            <p className='text-end text-white nb-0'>
              Hotline: <a className='text-white' href="tel:+91 9370075983">+91 9370075983</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className='container'>
        <div className='row align-items-center'>
          ...
          <div className="input-group ">
           ...
           <span className="input-group-text p-3" id="basic-addon2"><BsSearch className='f-6'/></span>
</div>
          </div>
          <div className='col-5'>
